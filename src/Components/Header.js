			...
			>
				...
				>
					<div className="flex-1  flex xl:flex-1 md:flex-none">
						<h1
							className={`font-logo text-5xl text-white pt-2 -ml-1 xl:text-8xl transform-gpu tracking-tight
					...
					<div
						className={`flex flex-1 items-center ${this.state.isOpen
							? 'flex flex-col  top-0 -left-3.5 right-0 bottom-0 fixed bg-blue-dark bg-opacity-95 min-h-screen justify-center -top-3 w-screen origin-center transform-gpu scale-150'
